...
#
# Generated by export_simulation on Sat Jul 08 23:40:38 +0800 2023
#
################################################################################
...
switch to the './imem_ip.sh' script.

./imem_ip.sh -reset_run
...
./imem_ip.sh -noclean_files

For more information on the script, please type './imem_ip.sh -help'.
